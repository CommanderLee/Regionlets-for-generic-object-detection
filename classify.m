...
elseif(result==6)
    %imgDir = '../CSC2541-AutoDriving/Project/data-kaist-thermal-original/test-all/images/';
    imgDir = '../CSC2541-AutoDriving/Project/cropped/';
    dirData = dir([imgDir '*.png']);
else
    classify;
end
...
for iFile = 1:n
    ...
    image_test=imread([imgDir image_test]);
